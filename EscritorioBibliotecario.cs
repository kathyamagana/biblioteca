...
{
    public partial class EscritorioBibliotecario : MaterialForm
    {
        public EscritorioBibliotecario()
        {
            InitializeComponent();
        }

        private void EscritorioBibliotecario_Load(object sender, EventArgs e)
        {
            /*
